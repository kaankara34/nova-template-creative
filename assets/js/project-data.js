...
const projects = {
  1: {
    ...
    images: [
      ...
      "assets/images/marti/marti-new4.webp",
      "assets/images/marti/marti-ic1.webp",
      "assets/images/marti/marti-ic2.webp",
      "assets/images/marti/marti-ic3.webp",
      "assets/images/marti/marti-ic4.webp",
      "assets/images/marti/marti-ic5.webp",
      "assets/images/marti/marti-ic6.webp",
      "assets/images/marti/marti-ic7.webp",
      "assets/images/marti/marti-ic8.webp",
      "assets/images/marti/marti-lavabo.webp",
      "assets/images/marti/marti-lavabo2.webp",
      "assets/images/marti/marti-manzara1.webp",
      "assets/images/marti/marti-manzara2.webp",
      "assets/images/marti/marti-manzara3.webp",
      "assets/images/marti/marti-manzara4.webp",
      "assets/images/marti/marti-mutfak1.webp",
      "assets/images/marti/marti-mutfak2.webp",
      "assets/images/marti/marti-lavabo.webp",
      "assets/images/marti/marti-lavabo2.webp",
  ...
  2: {
    ...
    unitCount: "29",
    images: [
      "assets/images/bahar/bahar-cephe-copy.webp",
      "assets/images/bahar/bahar-cephe-yan.webp",
      "assets/images/bahar/bahar-cephe-yan2.webp",
      "assets/images/bahar/bahar-peysaj-cephe.webp",
      "assets/images/bahar/bahar-peyzaj1.webp",
      "assets/images/bahar/bahar-peyzaj2.webp",
      "assets/images/bahar/bahar-peyzaj3.webp",
    ],
  ...
  3: {
    ...
    unitCount: "47",
    images: [
      "assets/images/mehtap/mehtap-render.webp",
      "assets/images/mehtap/mehtap-render2.webp",
      "assets/images/mehtap/mehtap-cephe1.webp",
      "assets/images/mehtap/mehtap-cephe2.webp",
    ],
    ozellikler: ["Fitness Merkezi", "Güvenlik", "Kapalı Otopark", "Kişisel Depolar", "Tam Kapasite Jeneratör","Toplantı Odası"],
  },
  4: {
    title: "Mercan Bosphorus Sitesi",
    description:
      "Çengelköy'de yer alan Mercan Bosphorus Çengelköy Sitesi, İstanbul'un en güzel bölgelerinden birinde konumlanmıştır. Proje, boğaz manzarasının keyfini çıkarabileceğiniz sahile, günlük ihtiyaçlarınızı karşılayabileceğiniz alışveriş merkezlerine ve işinize veya sevdiklerinize kolayca ulaşmanızı sağlayan ulaşım araçlarına yakın bir mesafededir. Site özellikleri arasında fitness merkezi, açık ve kapalı yüzme havuzları, sosyal tesisler, basketbol sahası, kapalı otopark ve bir adet tarihi eser bulunmaktadır. Projede yer alan daireler ise geniş ve ferah yaşam alanları sunmaktadır.",
    year: "2021",
    field: "18000",
    unitCount: "57",
    images: [
      "assets/images/mercan/mercan-peyzaj1.webp",
      "assets/images/mercan/mercan-peyzaj2.webp",
      "assets/images/mercan/mercan-peyzaj3.webp",
      "assets/images/mercan/mercan-peyzaj4.webp",
      "assets/images/mercan/mercan-peyzaj5.webp",
      "assets/images/mercan/mercan-peyzaj6.webp",
      "assets/images/mercan/mercan-peyzaj7.webp",
      "assets/images/mercan/mercan-peyzaj8.webp",
      "assets/images/mercan/mercan-basket.webp",
      "assets/images/mercan/mercan-blok1.webp",
      "assets/images/mercan/mercan-bloklar.webp",
      "assets/images/mercan/mercan-giris.webp",
      "assets/images/mercan/mercan-kapali-havuz.webp",
      "assets/images/mercan/mercan-park.webp",
    ],
    ozellikler: ["Açık havuz","Kapalı Havuz","Sauna, Buhar Odaları ve Hamam","Basketbol Sahası","Tenis Kortu", "Fitness Merkezi", "Sosyal Tesisler","Çocuk Oyun Parkları","Güvenlik", "Kapalı Otopark", "Kişisel Depolar", "Tam Kapasite Jeneratör","Nitelikli Peyzaj"],
  },
  5: {
    ...
    floor: 12,
    images: [
      "assets/images/dogan/dogan-cephe1.webp",
      "assets/images/dogan/dogan-cephe2.webp",
      "assets/images/dogan/dogan-cephe3.webp",
      "assets/images/dogan/dogan-cephe4.webp",
      "assets/images/dogan/dogan-cephe5.webp",
    ],
  },
  6: {
    title: "Falcon Plaza",
    ...
    field: "4000",
    floor: 8,
    images: ["assets/images/falcon/plaza/falcon-plaza.webp"],
  ...
  7: {
    ...
    field: "21500",
    images: [
      "assets/images/falcon/lojistik/falcon-dis.webp",
      "assets/images/falcon/lojistik/falcon-ic.webp",
      "assets/images/falcon/lojistik/falcon-lojistik-cephe.webp",
      "assets/images/falcon/lojistik/falcon-lojistik.webp",
    ],
  ...
  8: {
    ...
    field: "5500",
    images: [
      "assets/images/gebze-osb/osb-render.webp",
      "assets/images/gebze-osb/osb1.webp",
    ],
  ...
  9: {
    ...
    year: "2023",
    field: "6500",
    images: ["assets/images/konelsis/konelsis-render.webp"],
  },
};
